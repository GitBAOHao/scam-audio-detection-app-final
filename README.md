...
Audio-to-Text (ASR) – converts uploaded audio into text
Text Classification – predicts whether the message is a scam
Features
...
Model: openai/whisper-tiny (lightweight ASR model)
